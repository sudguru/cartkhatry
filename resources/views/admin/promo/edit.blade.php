...
<div class="d-flex align-items-center">
    <h2 class="pt-2 mb-0">Promo Links - Edit</h2>

</div>
<div class="row justify-content-center mt-3">
    <div class="col-md-10">
        <form action="{{ route('promo.update', $promo->id) }}" method="POST" autocomplete="off" novalidate class="mb-1">
            ...
            <div class="form-group">
                ...
                <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title"
                    value="{{ old('title') ?? $promo->title }}" autofocus>
            ...
            <div class="form-group">
                ...
                <input id="link" type="text" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link"
                    value="{{ old('link') ?? $promo->link  }}" autofocus>
