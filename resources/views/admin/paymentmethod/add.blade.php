...
<div class="d-flex align-items-center">
    <h2 class="pt-2 mb-0">Payment Method - Add</h2>

</div>
<div class="row justify-content-center mt-3">
    <div class="col-md-10">
        <form action="{{ route('paymentmethod.store') }}" method="POST" autocomplete="off" novalidate class="mb-1">
            ...
            <div class="form-group">
                ...
                <input id="payment_method" type="text" class="form-control{{ $errors->has('payment_method') ? ' is-invalid' : '' }}" name="payment_method"
                    value="{{ old('payment_method') }}" autofocus>
