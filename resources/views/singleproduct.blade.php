                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="product-single-details">
                            ...
                            <div style="margin-bottom: 2rem" class="product-filters-container">
                                <small>Prices</small>
                                <div class="dropdown">
                                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButtonPrice"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="min-width: 20rem">
                                    ...
                                    <div class="dropdown-menu custom-dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item custom-dropdown-link changeprice" href="javascript:void(0)"
                                            ...
                                            data-toqty="{{$price->toqty}}"  
                                            data-regular="{{$price->regular}}" 
                                            data-colors="{{$price->colors}}"
                                ...
                                <div id="product-price-detail" style="padding-top:2rem">
                                    <div class="price-box">
                                        @php
                                            $regular = $product->prices->first()->regular;
                                            $discounted = $product->prices->first()->discounted;
                                            $colors = explode('~', ltrim($product->prices->first()->colors,'~'));
                                        @endphp
                                    ...
                                    <div class="product-single-filter">
                                        ...
                                        <ul class="config-swatch-list">
                                            ...
                                            <li class="{{$key == 0 ? 'active' : '' }} productColor" data-color="{{$color}}">
                            ...
                            <div>
                                ...
                                <input type="hidden" id="cart_price" value= "{{$discounted}}" />
                                <input type="hidden" id="cart_color" value="{{$colors[0]}}"  />
                            </div>
                            <div class="sticky-header">
                                <div class="container">
                                    <div class="sticky-img">
                                        <img class="sticky-img-" src="assets/images/products/zoom/product-1.jpg" />
                                    </div>
