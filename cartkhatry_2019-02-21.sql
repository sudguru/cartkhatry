...
# Database: cartkhatry
# Generation Time: 2019-02-21 10:23:13 +0000
# ************************************************************
...
VALUES
	(1,'2019-02-21',1.00000,128.70186,80.66044,1.13359,1.49446,1.58498,125.53746,7.62115,8.89659,1275.69987,1.53308,1.13499,10.56903,7.46207,0.86989,'2019-02-05 16:18:38','2019-02-21 02:30:04');
...
VALUES
	...
	(51,6,'1550026584.jpg',0,0,1,1,'2019-02-13 02:56:24','2019-02-13 02:56:24'),
	(52,6,'1550026598.jpg',0,0,1,1,'2019-02-13 02:56:38','2019-02-13 02:56:38'),
	(53,1,'1550033639.jpg',0,0,1,1,'2019-02-13 04:54:00','2019-02-13 04:54:00'),
	(54,1,'1550033650.jpg',0,0,1,1,'2019-02-13 04:54:10','2019-02-13 04:54:10'),
	(55,1,'1550113807.jpg',0,0,1,1,'2019-02-14 03:10:07','2019-02-14 03:10:07');
...
VALUES
	(74,12,'featured',4,'2019-02-08 12:04:15','2019-02-14 04:23:02'),
	(75,27,'new',1,'2019-02-13 03:02:58','2019-02-13 03:02:58'),
	(76,27,'featured',3,'2019-02-13 03:03:08','2019-02-14 04:23:02'),
	(77,28,'featured',1,'2019-02-14 04:23:02','2019-02-14 04:23:02');
...
INSERT INTO `productprices` (`id`, `product_id`, `size_id`, `regular`, `discounted`, `discount_valid_until`, `display_order`, `stock`, `created_at`, `updated_at`)
VALUES
	(53,12,'1',1380.00,1150.00,NULL,NULL,1,'2019-01-04 09:57:22','2019-01-04 09:57:22'),
	(54,13,'1',1350.00,1300.00,NULL,NULL,1,'2019-01-04 14:12:32','2019-01-04 14:12:32'),
	(55,14,'1',3500.00,2450.00,NULL,NULL,1,'2019-01-06 06:43:08','2019-01-06 06:43:08'),
	(56,15,'1',300.00,250.00,NULL,NULL,1,'2019-01-06 09:08:11','2019-01-06 09:08:11'),
	(57,16,'1',1100.00,799.00,NULL,NULL,1,'2019-01-06 09:10:44','2019-01-06 09:10:44'),
	(58,17,'1',1150.00,950.00,NULL,NULL,1,'2019-01-06 09:15:11','2019-01-06 09:15:11'),
	(59,18,'1',425.00,350.00,NULL,NULL,1,'2019-01-06 09:17:50','2019-01-06 09:17:50'),
	(60,19,'1',1500.00,1099.00,NULL,NULL,1,'2019-01-06 09:21:30','2019-01-06 09:21:30'),
	(62,21,'1',2200.00,1800.00,NULL,NULL,1,'2019-01-06 09:31:33','2019-01-06 09:31:33'),
	(64,23,'1',500.00,400.00,NULL,NULL,1,'2019-01-13 09:40:57','2019-01-13 09:40:57'),
	(66,23,'3',500.00,400.00,NULL,NULL,1,'2019-01-13 09:42:15','2019-01-13 09:42:15'),
	(67,20,'1',55000.00,54000.00,'2019-02-20',NULL,1,'2019-02-06 02:44:40','2019-02-06 02:44:40'),
	(68,20,'3',56000.00,55000.00,'2019-02-20',NULL,1,'2019-02-06 02:45:03','2019-02-06 02:45:03'),
	(69,26,'1',55.00,55.00,'2019-02-08',NULL,1,'2019-02-08 11:59:15','2019-02-08 11:59:15'),
	(78,22,'13',223.00,211.00,NULL,NULL,1,'2019-02-12 04:28:45','2019-02-12 04:30:49'),
	(80,22,'4',33.00,22.00,'2019-02-27',NULL,1,'2019-02-12 04:32:44','2019-02-12 04:33:16'),
	(81,22,'3',55.00,44.00,'2019-02-21',NULL,1,'2019-02-12 04:37:46','2019-02-12 05:08:32'),
	(85,22,'13',223.00,113.00,'2019-02-20',NULL,1,'2019-02-12 04:53:26','2019-02-12 05:08:06'),
	(86,27,'2',566.00,566.00,'2019-02-14',NULL,0,'2019-02-13 02:55:44','2019-02-13 03:42:51'),
	(87,27,'1',600.00,550.00,'2019-02-28',NULL,1,'2019-02-13 02:58:54','2019-02-19 03:05:41'),
	(88,27,'4',700.00,600.00,'2019-02-21',NULL,1,'2019-02-13 03:01:18','2019-02-13 03:01:18'),
	(90,28,'1',600.00,550.00,NULL,NULL,1,'2019-02-14 02:57:25','2019-02-14 02:57:25'),
	(91,28,'4',900.00,850.00,NULL,NULL,1,'2019-02-14 02:57:52','2019-02-14 02:57:52'),
	(92,28,'8',998.00,991.00,'2019-02-20',NULL,1,'2019-02-14 03:00:58','2019-02-14 03:08:51'),
	(93,12,'2',1000.00,900.00,'2019-02-19',NULL,1,'2019-02-18 06:46:09','2019-02-18 06:46:09');
...
INSERT INTO `products` (`id`, `category_id`, `brand_id`, `name`, `slug`, `description`, `specification`, `user_id`, `last_modified_user_id`, `category_order`, `viewed_rank`, `approved`, `delivery_available`, `delivery_day_from`, `delivery_day_to`, `delivery_charge_local`, `delivery_charge_intercity`, `delivery_charge_intl`, `manufactured_in`, `primarycurrency`, `created_at`, `updated_at`, `paymentmanagedby`)
VALUES
	(12,37,1,'Car Back Seat Organizer','12-car-back-seat-organizer','<p>Multifunctional Seat Bag Automobile Storage Box Hanging Bag Leather Chair Storage Bag Car Accessories Car-styling<br></p>','Multifunctional Seat Bag Automobile Storage Box Hanging Bag Leather Chair Storage Bag Car Accessories Car-styling',1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-04 09:57:01','2019-02-18 06:46:36','Self'),
	(13,33,1,'5 Tier shoe Rack','13-5-tier-shoe-rack','<p>5 Tier X Shaped Shoe Rack Organizer is portable and easy to assemble, it can store up to 15 Pairs of shoes.<br></p>','It Helps Maintain Shoe Shape. This Product Is Loved and used by Millions Of People As Soon As It Appeared On Television.',1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-04 14:11:47','2019-01-04 14:11:47','Self'),
	(14,34,1,'6 Tier Covered Shoes Rack','14-6-tier-covered-shoes-rack','<div>6 Tier Covered Shoes Rack DIY Storage Shelf is portable and easy to assemble, it can store up to 15 Pairs of shoes.</div><div>It Helps Maintain Shoe Shape. This Product Is Loved and used by Millions Of People As Soon As It Appeared On Television.</div>','<div><br></div>',1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 06:41:15','2019-02-06 02:59:34','Self'),
	(15,33,1,'Coffee Mixer','15-coffee-mixer','<p>Best Quality,&nbsp;<span style=\"font-size: 1.4rem;\">Easy to use,&nbsp;</span><span style=\"font-size: 1.4rem;\">Best Result</span></p>',NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:07:19','2019-01-06 09:07:19','Self'),
	(16,33,1,'Shoe Organizer','16-shoe-organizer','<p><span style=\"font-size: 1.4rem;\">100% Cotton,&nbsp;</span><span style=\"font-size: 1.4rem;\">Imported,&nbsp;</span><span style=\"font-size: 1.4rem;\">Ventil Air breathable</span></p>',NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:10:20','2019-01-06 09:10:20','Self'),
	(17,34,1,'Shoe Organizer','17-shoe-organizer','<p>100% SATISFACTION GUARANTEED,&nbsp;<span style=\"font-size: 1.4rem;\">1 Set ñ 6 Piece,&nbsp;</span><span style=\"font-size: 1.4rem;\">Space Saver</span></p>',NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:14:49','2019-01-06 09:14:49','Self'),
	(18,30,1,'Refrigerator Box','18-refrigerator-box','<p><span style=\"font-size: 1.4rem;\">Made of ABS, non-toxic and wear resistant.&nbsp;</span><span style=\"font-size: 1.4rem;\">his is a convenient storage organizer for your refrigerator or in the kitchen.&nbsp;</span><span style=\"font-size: 1.4rem;\">Cab to be used in refrigerator, kitchen pantry or for storing fruits, eggs, snacks etc.</span></p>','<p>Size: 20.3cm * 14.7cm * 6.7cm</p><p>Heart-shaped hollow out design for ventilation and drainage of water.</p><div><br></div>',1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:17:25','2019-01-06 09:17:25','Self'),
	(19,35,1,'Dolphin Massager','19-dolphin-massager','<p><span style=\"font-size: 1.4rem;\">Burn fat and partly lose weight (messager)</span><br></p><p><br></p>',NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:19:49','2019-01-06 09:19:49','Self'),
	(20,30,1,'Wireless Massager','20-wireless-massager',NULL,NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-01-06 09:28:47','2019-01-06 09:28:47','Self'),
	(21,30,1,'Double Egg Boiler','21-double-egg-boiler','<div><span style=\"font-size: 1.4rem;\">14 egg slots,&nbsp;</span><span style=\"font-size: 1.4rem;\">easy and convenient</span></div>','<div><br></div>',1,1,NULL,NULL,NULL,1,NULL,5,200,500,2000,'China','NPR','2019-01-06 09:31:01','2019-01-06 12:52:22','Self'),
	(22,33,1,'Electric Egg Boiler','22-electric-egg-boiler',NULL,NULL,1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','SGD','2019-01-06 09:32:03','2019-02-12 02:30:53','Self'),
	(26,38,1,'Cool Product','26-sdfgsdfg',NULL,NULL,6,6,NULL,NULL,NULL,1,2,5,200,500,2000,'Colombia','EUR','2019-02-08 05:25:05','2019-02-08 06:10:14','KhatryOnline.com'),
	(27,32,2,'New Product','27-new-product','<p>sd</p>','ds',6,6,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-02-13 02:55:44','2019-02-13 02:55:44','KhatryOnline.com'),
	(28,38,1,'My Product','28-my-product','<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Amet, nunc placerat congue montes parturient viverra class, metus taciti quis lacus sociis nisi tempor magna ultrices fames auctor lacinia tortor rutrum.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Per ridiculus suscipit. Eros cum conubia velit ultricies aptent a massa lorem, pretium. Elit sem convallis egestas primis ante, ornare. Bibendum blandit posuere ligula placerat tellus dictum etiam.</p>','<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Dapibus tincidunt taciti interdum primis odio praesent feugiat. Tempus mollis phasellus. Blandit. Quis. Porta natoque.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Etiam. Maecenas cubilia conubia congue eleifend risus aptent. Vestibulum senectus natoque.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Aliquam fusce ultrices platea eget sem praesent ridiculus condimentum tristique.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Elit nibh nonummy, nonummy. Tortor hac netus natoque facilisis.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Gravida sapien dui sem pharetra eu odio adipiscing.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Etiam molestie taciti et massa, taciti in et odio.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Duis morbi, mus a. Nisl venenatis scelerisque donec suspendisse aenean.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Natoque litora, viverra odio curabitur posuere facilisis dapibus sociosqu cras.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Orci neque in ultrices. Libero eget tempus suscipit nascetur eleifend.</p><p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px; font-size: 12.16px; color: rgb(85, 85, 85); font-family: Arial, sans-serif;\">Nostra suscipit hymenaeos id phasellus ornare inceptos ut.</p>',1,1,NULL,NULL,NULL,1,2,5,200,500,2000,'China','NPR','2019-02-13 04:52:39','2019-02-18 06:55:34','Self');
...
VALUES
	...
	(17,'Hot Sudeep','gurung_sudeep@hotmail.com',NULL,'$2y$10$9BzPr8b42iOE5yuXM2GHM.YQbUd0ZDd2UWSmKigw7FSRJILW70BgO','ySCMngxbQkF67SofXCbCWYYY0opq5PsQ83omAjXtcOaoPJ9zkbAGPVh8vwSu','2019-02-19 07:35:35','2019-02-19 07:35:35');
